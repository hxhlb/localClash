...
| 渠道 | 最新版本 | 發佈時間 |
| --- | --- | --- |
| localClash Core | [v0.1.41](https://github.com/qoli/localClash/releases/tag/v0.1.41) | 2026-06-04 21:08 UTC+8 |
| localclash-luci | [v0.1.0-37](https://github.com/qoli/localclash-luci/releases/tag/v0.1.0-37) | 2026-06-04 21:13 UTC+8 |

## 2026-06-04

### localClash Core v0.1.41
...
- GitHub Release `v0.1.41` 已包含 linux amd64/arm64、base assets、
  release manifest 和 checksum assets。
- Release workflow `26953620220` 已完成，`test` 與 `build-release` job
  均成功。
